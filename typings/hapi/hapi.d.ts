...
declare module "hapi" {
    ...
    export interface IServerInject {
        (options:{
         ...
         callback:(/**the response object where:
                    ...
                    request - the request object.*/
                   res:{ statusCode: number; headers: IDictionary<string>; payload: string; rawPayload: Buffer; raw: { req: http.ClientRequest; res: http.ServerResponse }; result: string; request: Request }) => void):void;
