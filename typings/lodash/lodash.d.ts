...
declare module _ {
    ...
    interface LoDashStatic {
         ...
         */
        takeWhile<T>(array:(Array<T>|List<T>),
         ...
         */
        takeWhile<W, T>(array:(Array<T>|List<T>),
                        whereValue:W): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @param pluckValue Uses a _.property style callback to return the property value of the given element
         **/
        takeWhile<T>(pluckValue:string): LoDashArrayWrapper<any>;

        /**
         * Takes the first items based on a predicate
         * @param whereValue Uses a _.matches style callback to return the first elements that match the given value
         **/
        takeWhile<W, T>(whereValue:W): LoDashArrayWrapper<T>;
    ...
    interface LoDashStatic {
         ...
         * @see _.rest
         **/
        rest<W, T>(array:Array<T>,
                   whereValue:W): T[];

        /**
         * @see _.rest
         **/
        rest<W, T>(array:List<T>,
                   whereValue:W): T[];
         ...
         * @see _.rest
         **/
        tail<W, T>(array:Array<T>,
                   whereValue:W): T[];

        /**
         * @see _.rest
         **/
        tail<W, T>(array:List<T>,
                   whereValue:W): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         */
        slice(start?:number,
              end?:number): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         **/
        sortedIndex<T, TSort>(array:Array<T>,
                              value:T,
                              callback?:(x:T) => TSort,
                              thisArg?:any): number;
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.uniq
         **/
        uniq<TSort>(callback:ListIterator<T, TSort>,
                    thisArg?:any): LoDashArrayWrapper<T>;
         ...
         * @param whereValue _.where style callback
         **/
        uniq<W>(whereValue:W): LoDashArrayWrapper<T>;
         ...
         * @see _.uniq
         **/
        unique<TSort>(callback:ListIterator<T, TSort>,
                      thisArg?:any): LoDashArrayWrapper<T>;
         ...
         * @param whereValue _.where style callback
         **/
        unique<W>(whereValue:W): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         **/
        zipObject<TResult extends {}>(props:List<string>,
         ...
         * @see _.zipObject
         **/
        object<TResult extends {}>(props:List<string>,
                                   values?:List<any>): TResult;
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.thru
         */
        thru<TResult extends Object>(interceptor:(value:T) => TResult,
    ...
    interface LoDashStatic {
        ...
        at<T>(collection:List<T>|Dictionary<T>,
              ...props:Array<number|string|Array<number|string>>): T[];
    }
    ...
    interface LoDashStatic {
         ...
         * @see _.map
         */
        collect<T, TResult>(collection:List<T>,
         ...
         * @see _.map
         */
        collect<T extends {}, TResult>(collection:Dictionary<T>,
         ...
         * @see _.map
         */
        collect<T, TResult>(collection:Dictionary<T>,
                            iteratee?:string): TResult[];

        /**
         * @see _.map
         */
        collect<T, TObject extends {}>(collection:List<T>,
                                       iteratee?:TObject): boolean[];

        /**
         * @see _.map
         */
        collect<T, TObject extends {}>(collection:Dictionary<T>,
                                       iteratee?:TObject): boolean[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.map
         */
        collect<TResult>(iteratee?:ListIterator<T, TResult>,
                         thisArg?:any): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         */
        collect<TResult>(iteratee?:string): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         */
        collect<TObject extends {}>(iteratee?:TObject): LoDashArrayWrapper<boolean>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.map
         */
        collect<TValue, TResult>(iteratee?:ListIterator<TValue, TResult>|DictionaryIterator<TValue, TResult>,
                                 thisArg?:any): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         */
        collect<TValue, TResult>(iteratee?:string): LoDashArrayWrapper<TResult>;
    ...
    interface LoDashStatic {
         ...
         **/
        contains<T>(dictionary:Dictionary<T>,
                    value:T,
                    fromIndex?:number): boolean;
         ...
         * @see _.contains
         **/
        include<T>(dictionary:Dictionary<T>,
                   value:T,
                   fromIndex?:number): boolean;
         ...
         * @see _.contains
         **/
        includes<T>(dictionary:Dictionary<T>,
                    value:T,
                    fromIndex?:number): boolean;
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.countBy
         **/
        countBy(callback?:ListIterator<T, any>,
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        every<W, T>(collection:Dictionary<T>,
                    whereValue:W): boolean;

        /**
         * @see _.every
         **/
        all<T>(collection:Array<T>,
               callback?:ListIterator<T, boolean>,
               thisArg?:any): boolean;
         ...
         * @param whereValue _.where style callback
         **/
        all<W, T>(collection:Dictionary<T>,
                  whereValue:W): boolean;
    }
    ...
    interface LoDashStatic {
         ...
         * @param pluckValue _.pluck style callback
         **/
        filter<W, T>(collection:Dictionary<T>,
                     whereValue:W): T[];

        /**
         * @see _.filter
         **/
        select<T>(collection:Array<T>,
                  callback:ListIterator<T, boolean>,
                  thisArg?:any): T[];
         ...
         * @see _.filter
         **/
        select<T>(collection:Dictionary<T>,
                  callback:DictionaryIterator<T, boolean>,
                  thisArg?:any): T[];
         ...
         * @param pluckValue _.pluck style callback
         **/
        select<W, T>(collection:Dictionary<T>,
                     whereValue:W): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.filter
         **/
        filter(callback:ListIterator<T, boolean>,
               thisArg?:any): LoDashArrayWrapper<T>;
         ...
         * @param pluckValue _.pluck style callback
         **/
        filter(pluckValue:string): LoDashArrayWrapper<T>;

        /**
         * @see _.filter
         * @param pluckValue _.pluck style callback
         **/
        filter<W>(whereValue:W): LoDashArrayWrapper<T>;

        /**
         * @see _.filter
         **/
        select(callback:ListIterator<T, boolean>,
               thisArg?:any): LoDashArrayWrapper<T>;
         ...
         * @param pluckValue _.pluck style callback
         **/
        select(pluckValue:string): LoDashArrayWrapper<T>;

        /**
         * @see _.filter
         * @param pluckValue _.pluck style callback
         **/
        select<W>(whereValue:W): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.filter
         **/
        filter<T extends {}>(callback:ObjectIterator<T, boolean>,
    ...
    interface LoDashStatic {
         ...
         * @see _.find
         **/
        detect<T>(collection:Dictionary<T>,
                  callback:DictionaryIterator<T, boolean>,
                  thisArg?:any): T;
         ...
         **/
        find<W, T>(collection:Array<T>|List<T>|Dictionary<T>,
                   whereValue:W): T;
         ...
         * @param _.matches style callback
         **/
        detect<W, T>(collection:Array<T>|List<T>|Dictionary<T>,
                     whereValue:W): T;
         ...
         **/
        find<T>(collection:Array<T>|List<T>|Dictionary<T>,
                path:string,
                srcValue:any): T;
         ...
         * @param _.matchesProperty style callback
         **/
        detect<T>(collection:Array<T>|List<T>|Dictionary<T>,
                  path:string,
                  srcValue:any): T;
         ...
         * @see _.find
         **/
        findWhere<T>(collection:Array<T>,
                     callback:ListIterator<T, boolean>,
                     thisArg?:any): T;
         ...
         * @see _.find
         **/
        findWhere<T>(collection:Dictionary<T>,
                     callback:DictionaryIterator<T, boolean>,
                     thisArg?:any): T;
         ...
         * @param _.matches style callback
         **/
        findWhere<W, T>(collection:Array<T>,
                        whereValue:W): T;
         ...
         * @param _.matches style callback
         **/
        findWhere<W, T>(collection:List<T>,
                        whereValue:W): T;
         ...
         * @param _.matches style callback
         **/
        findWhere<W, T>(collection:Dictionary<T>,
                        whereValue:W): T;
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.find
         */
        find(callback:ListIterator<T, boolean>,
             thisArg?:any): T;
        /**
         * @see _.find
         * @param _.matches style callback
    ...
    interface LoDashStatic {
         ...
         * @see _.forEach
         **/
        forEach<T extends {}>(object:Dictionary<T>,
         ...
         * @see _.each
         **/
        forEach<T extends {}, TValue>(object:T,
         ...
         * @param thisArg The this binding of callback.
         **/
        each<T extends {}>(object:Dictionary<T>,
                           callback:DictionaryIterator<T, void>,
                           thisArg?:any): Dictionary<T>;
         ...
         * @see _.each
         **/
        each<T extends {}, TValue>(object:T,
                                   callback:ObjectIterator<TValue, void>,
                                   thisArg?:any): T
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.forEach
         **/
        forEach(callback:ListIterator<T, void>,
                thisArg?:any): LoDashArrayWrapper<T>;

        /**
         * @see _.forEach
         **/
        each(callback:ListIterator<T, void>,
             thisArg?:any): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forEach
         **/
        forEach<T extends {}>(callback:ObjectIterator<T, void>,
                              thisArg?:any): LoDashObjectWrapper<T>;

        /**
         * @see _.forEach
         **/
        each<T extends {}>(callback:ObjectIterator<T, void>,
                           thisArg?:any): LoDashObjectWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         * @param thisArg The this binding of callback.
         **/
        forEachRight<T>(collection:Array<T>,
                        callback:ListIterator<T, void>,
                        thisArg?:any): Array<T>;
         ...
         * @see _.forEachRight
         **/
        forEachRight<T extends {}>(object:Dictionary<T>,
                                   callback:DictionaryIterator<T, void>,
                                   thisArg?:any): Dictionary<T>;
         ...
         * @see _.forEachRight
         **/
        eachRight<T>(collection:Array<T>,
                     callback:ListIterator<T, void>,
                     thisArg?:any): Array<T>;
         ...
         * @param thisArg The this binding of callback.
         **/
        eachRight<T extends {}>(object:Dictionary<T>,
                                callback:DictionaryIterator<T, void>,
                                thisArg?:any): Dictionary<T>;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.forEachRight
         **/
        forEachRight(callback:ListIterator<T, void>,
                     thisArg?:any): LoDashArrayWrapper<T>;

        /**
         * @see _.forEachRight
         **/
        eachRight(callback:ListIterator<T, void>,
                  thisArg?:any): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forEachRight
         **/
        forEachRight<T extends {}>(callback:ObjectIterator<T, void>,
         ...
         * @param thisArg The this binding of callback.
         **/
        eachRight<T extends {}>(callback:ObjectIterator<T, void>,
                                thisArg?:any): LoDashObjectWrapper<Dictionary<T>>;
    }
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        groupBy<W, T>(collection:Array<T>,
         ...
         * @param whereValue _.where style callback
         **/
        groupBy<W, T>(collection:List<T>,
                      whereValue:W): Dictionary<T[]>;

        /**
         * @see _.groupBy
         **/
        groupBy<T>(collection:Dictionary<T>,
                   callback?:DictionaryIterator<T, any>,
                   thisArg?:any): Dictionary<T[]>;
         ...
         * @param pluckValue _.pluck style callback
         **/
        groupBy<TValue>(collection:Dictionary<TValue>,
         ...
         * @param whereValue _.where style callback
         **/
        groupBy<W, TValue>(collection:Dictionary<TValue>,
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.groupBy
         **/
        groupBy(callback:ListIterator<T, any>,
                thisArg?:any): _.LoDashObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy(pluckValue:string): _.LoDashObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W>(whereValue:W): _.LoDashObjectWrapper<_.Dictionary<T[]>>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.groupBy
         **/
        groupBy<TValue>(callback:ListIterator<TValue, any>,
                        thisArg?:any): _.LoDashObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<TValue>(pluckValue:string): _.LoDashObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W, TValue>(whereValue:W): _.LoDashObjectWrapper<_.Dictionary<TValue[]>>;
    }
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        indexBy<W, T>(collection:Array<T>,
                      whereValue:W): Dictionary<T>;
    ...
    interface LoDashStatic {
         ...
         **/
        invoke<T extends {}>(collection:Array<T>,
                             methodName:string,
                             ...args:any[]): any;
         ...
         * @see _.invoke
         **/
        invoke<T extends {}>(collection:List<T>,
                             methodName:string,
                             ...args:any[]): any;
         ...
         * @see _.invoke
         **/
        invoke<T extends {}>(collection:Dictionary<T>,
                             methodName:string,
                             ...args:any[]): any;
    ...
    interface LoDashStatic {
         ...
         * @see _.map
         */
        map<T, TResult>(collection:Dictionary<T>,
                        iteratee?:string): TResult[];

        /**
         * @see _.map
         */
        map<T, TObject extends {}>(collection:List<T>,
                                   iteratee?:TObject): boolean[];

        /**
         * @see _.map
         */
        map<T, TObject extends {}>(collection:Dictionary<T>,
                                   iteratee?:TObject): boolean[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.map
         */
        map<TResult>(iteratee?:string): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         */
        map<TObject extends {}>(iteratee?:TObject): LoDashArrayWrapper<boolean>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.map
         */
        map<TValue, TResult>(iteratee?:string): LoDashArrayWrapper<TResult>;
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        max<W, T>(collection:Dictionary<T>,
                  whereValue:W): T;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.max
         **/
        max(callback?:ListIterator<T, any>,
         ...
         * @param pluckValue _.pluck style callback
         **/
        max(pluckValue:string): LoDashWrapper<T>;

        /**
         * @see _.max
         * @param whereValue _.where style callback
         **/
        max<W>(whereValue:W): LoDashWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        min<W, T>(collection:Dictionary<T>,
                  whereValue:W): T;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.min
         **/
        min(callback?:ListIterator<T, any>,
            thisArg?:any): LoDashWrapper<T>;
         ...
         * @param pluckValue _.pluck style callback
         **/
        min(pluckValue:string): LoDashWrapper<T>;

        /**
         * @see _.min
         * @param whereValue _.where style callback
         **/
        min<W>(whereValue:W): LoDashWrapper<T>;
    }
    ...
    interface LoDashNumberArrayWrapper {
         ...
         * @see _.sum
         **/
        sum(iteratee:ListIterator<number, number>,
            thisArg?:any): number;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.sum
         **/
        sum(iteratee:ListIterator<T, number>,
            thisArg?:any): number;
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.sum
         **/
        sum(iteratee:ObjectIterator<any, number>,
            thisArg?:any): number;
    ...
    interface LoDashStatic {
         ...
         **/
        pluck<T extends {}>(collection:Array<T>,
                            property:string|string[]): any[];

        /**
         * @see _.pluck
         **/
        pluck<T extends {}>(collection:List<T>,
                            property:string|string[]): any[];

        /**
         * @see _.pluck
         **/
        pluck<T extends {}>(collection:Dictionary<T>,
                            property:string|string[]): any[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.pluck
         **/
        pluck<TResult>(property:string): LoDashArrayWrapper<TResult>;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.partition
         */
        partition<W>(whereValue:W): LoDashArrayWrapper<T[]>;
        /**
         * @see _.partition
         */
         ...
         * @see _.partition
         */
        partition(pluckValue:string): LoDashArrayWrapper<T[]>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.partition
         */
        partition<W, TResult>(whereValue:W): LoDashArrayWrapper<TResult[]>;
         ...
         * @see _.partition
         */
        partition<TResult>(pluckValue:string): LoDashArrayWrapper<TResult[]>;
    }
    ...
    interface LoDashStatic {
         ...
         * @see _.reduce
         **/
        inject<T, TResult>(collection:Array<T>,
                           callback:MemoIterator<T, TResult>,
                           accumulator:TResult,
                           thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        inject<T, TResult>(collection:List<T>,
                           callback:MemoIterator<T, TResult>,
                           accumulator:TResult,
                           thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        inject<T, TResult>(collection:Dictionary<T>,
                           callback:MemoIterator<T, TResult>,
                           accumulator:TResult,
                           thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        foldl<T, TResult>(collection:Array<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        foldl<T, TResult>(collection:List<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        foldl<T, TResult>(collection:Dictionary<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.reduce
         **/
        inject<TResult>(callback:MemoIterator<T, TResult>,
                        accumulator:TResult,
                        thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        foldl<TResult>(callback:MemoIterator<T, TResult>,
                       accumulator:TResult,
                       thisArg?:any): TResult;
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.reduce
         **/
        inject<TValue, TResult>(callback:MemoIterator<TValue, TResult>,
                                accumulator:TResult,
                                thisArg?:any): TResult;
         ...
         * @see _.reduce
         **/
        foldl<TValue, TResult>(callback:MemoIterator<TValue, TResult>,
                               accumulator:TResult,
                               thisArg?:any): TResult;
    ...
    interface LoDashStatic {
         ...
         * @see _.reduceRight
         **/
        foldr<T, TResult>(collection:Array<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
         ...
         * @see _.reduceRight
         **/
        foldr<T, TResult>(collection:List<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
         ...
         * @see _.reduceRight
         **/
        foldr<T, TResult>(collection:Dictionary<T>,
                          callback:MemoIterator<T, TResult>,
                          accumulator:TResult,
                          thisArg?:any): TResult;
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        reject<W, T>(collection:Dictionary<T>,
                     whereValue:W): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.reject
         **/
        reject(callback:ListIterator<T, boolean>,
               thisArg?:any): LoDashArrayWrapper<T>;
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        some<W, T>(collection:Dictionary<T>,
                   whereValue:W): boolean;

        /**
         * @see _.some
         **/
        any<T>(collection:Array<T>,
               callback?:ListIterator<T, boolean>,
               thisArg?:any): boolean;
         ...
         * @param whereValue _.where style callback
         **/
        any<W, T>(collection:Dictionary<T>,
                  whereValue:W): boolean;
    }
    ...
    interface LoDashStatic {
         ...
         **/
        sortBy<T, TSort>(collection:Array<T>,
         ...
         */
        sortByAll<T>(collection:(Array<T>|List<T>),
                     ...args:(ListIterator<T, boolean>|Object|string)[]): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.sortBy
         **/
        sortBy<TSort>(iteratee?:ListIterator<T, TSort>,
                      thisArg?:any): LoDashArrayWrapper<T>;
    ...
    interface LoDashStatic {
         ...
         * @return A new array of sorted elements.
         **/
        sortByAll<T>(collection:Array<T>,
                     iteratees:(ListIterator<T, any>|string|Object)[]): T[];

        /**
         * @see _.sortByAll
         **/
        sortByAll<T>(collection:List<T>,
                     iteratees:(ListIterator<T, any>|string|Object)[]): T[];
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.sortByAll
         **/
        sortByAll(iteratees:(ListIterator<T, any>|string|Object)[]): LoDashArrayWrapper<T>;
    ...
    interface LoDashStatic {
         ...
         * @return A new array of sorted elements.
         **/
        sortByOrder<T>(collection:Array<T>,
         ...
         * @see _.sortByOrder
         **/
        sortByOrder<T>(collection:List<T>,
                       iteratees:(ListIterator<T, any>|string|Object)[],
                       orders?:boolean[]): T[];
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.sortByOrder
         **/
        sortByOrder(iteratees:(ListIterator<T, any>|string|Object)[],
    ...
    interface LoDashStatic {
         ...
         **/
        where<T, U extends {}>(list:Array<T>,
                               properties:U): T[];

        /**
         * @see _.where
         **/
        where<T, U extends {}>(list:List<T>,
                               properties:U): T[];

        /**
         * @see _.where
         **/
        where<T, U extends {}>(list:Dictionary<T>,
                               properties:U): T[];
    }
    ...
    interface LoDashStatic {
         ...
         */
        memoize<TResult extends MemoizedFunction>(func:Function,
    ...
    interface LoDashStatic {
         ...
         * @return Returns the new function.
         */
        modArgs<T extends Function, TResult extends Function>(func:T,
    ...
    interface LoDashWrapper<T> {
         ...
         * @see _.clone
         */
        clone(customizer?:(value:any) => any,
              thisArg?:any): T;
    }
    ...
    interface LoDashWrapper<T> {
         ...
         * @see _.cloneDeep
         */
        cloneDeep(customizer?:(value:any) => any,
                  thisArg?:any): T;
    }
    ...
    interface LoDashStatic {
         ...
         **/
        assign<P, T, S1, Value, Result>(object:T,
                                        s1:S1,
         ...
         * @see _.assign
         **/
        assign<P, T, S1, S2, Value, Result>(object:T,
                                            s1:S1,
                                            s2:S2,
                                            callback?:(objectValue:Value, sourceValue:Value) => Value,
                                            thisArg?:any): Result;
         ...
         * @see _.assign
         **/
        assign<P, T, S1, S2, S3, Value, Result>(object:T,
                                                s1:S1,
                                                s2:S2,
                                                s3:S3,
                                                callback?:(objectValue:Value, sourceValue:Value) => Value,
         ...
         * @see _.assign
         **/
        assign<P, T, S1, S2, S3, S4, Value, Result>(object:T,
                                                    s1:S1,
                                                    s2:S2,
                                                    s3:S3,
                                                    s4:S4,
         ...
         * @see _.assign
         **/
        extend<P, T, S1, Value, Result>(object:T,
                                        s1:S1,
                                        callback?:(objectValue:Value, sourceValue:Value) => Value,
                                        thisArg?:any): Result;
         ...
         * @see _.assign
         **/
        extend<P, T, S1, S2, Value, Result>(object:T,
                                            s1:S1,
                                            s2:S2,
                                            callback?:(objectValue:Value, sourceValue:Value) => Value,
                                            thisArg?:any): Result;
         ...
         * @see _.assign
         **/
        extend<P, T, S1, S2, S3, Value, Result>(object:T,
                                                s1:S1,
                                                s2:S2,
                                                s3:S3,
                                                callback?:(objectValue:Value, sourceValue:Value) => Value,
         ...
         * @see _.assign
         **/
        extend<P, T, S1, S2, S3, S4, Value, Result>(object:T,
                                                    s1:S1,
                                                    s2:S2,
                                                    s3:S3,
                                                    s4:S4,
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.assign
         **/
        assign<S1, S2, Value, TResult>(s1:S1,
                                       s2:S2,
                                       callback?:(objectValue:Value, sourceValue:Value) => Value,
                                       thisArg?:any): TResult;
        /**
         * @see _.assign
         **/
        assign<S1, S2, S3, Value, TResult>(s1:S1,
                                           s2:S2,
                                           s3:S3,
                                           callback?:(objectValue:Value, sourceValue:Value) => Value,
                                           thisArg?:any): TResult;
         ...
         * @see _.assign
         **/
        assign<S1, S2, S3, S4, Value, TResult>(s1:S1,
                                               s2:S2,
                                               s3:S3,
                                               s4:S4,
                                               callback?:(objectValue:Value, sourceValue:Value) => Value,
         ...
         * @see _.assign
         **/
        assign<S1, S2, S3, S4, S5, Value, TResult>(s1:S1,
                                                   s2:S2,
                                                   s3:S3,
                                                   s4:S4,
                                                   s5:S5,
         ...
         * @see _.assign
         **/
        extend<S1, S2, Value, TResult>(s1:S1,
                                       s2:S2,
                                       callback?:(objectValue:Value, sourceValue:Value) => Value,
                                       thisArg?:any): TResult;
        /**
         * @see _.assign
         **/
        extend<S1, S2, S3, Value, TResult>(s1:S1,
                                           s2:S2,
                                           s3:S3,
                                           callback?:(objectValue:Value, sourceValue:Value) => Value,
                                           thisArg?:any): TResult;
         ...
         * @see _.assign
         **/
        extend<S1, S2, S3, S4, Value, TResult>(s1:S1,
                                               s2:S2,
                                               s3:S3,
                                               s4:S4,
                                               callback?:(objectValue:Value, sourceValue:Value) => Value,
         ...
         * @see _.assign
         **/
        extend<S1, S2, S3, S4, S5, Value, TResult>(s1:S1,
                                                   s2:S2,
                                                   s3:S3,
                                                   s4:S4,
                                                   s5:S5,
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        findKey<W extends Dictionary<any>, T>(object:T,
                                              whereValue:W): string;
    }
    ...
    interface LoDashStatic {
         ...
         * @param whereValue _.where style callback
         **/
        findLastKey<W extends Dictionary<any>, T>(object:T,
                                                  whereValue:W): string;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forIn
         **/
        forIn<T extends {}>(callback:ObjectIterator<T, void>,
    ...
    interface LoDashStatic {
         ...
         * @return object
         **/
        forInRight<T extends {}>(object:Dictionary<T>,
                                 callback?:DictionaryIterator<T, void>,
                                 thisArg?:any): Dictionary<T>;
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forInRight
         **/
        forInRight<T extends {}>(callback:ObjectIterator<T, void>,
                                 thisArg?:any): _.LoDashObjectWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         * @return object
         **/
        forOwn<T extends {}>(object:Dictionary<T>,
                             callback?:DictionaryIterator<T, void>,
                             thisArg?:any): Dictionary<T>;
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forOwn
         **/
        forOwn<T extends {}>(callback:ObjectIterator<T, void>,
                             thisArg?:any): _.LoDashObjectWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         * @return object
         **/
        forOwnRight<T extends {}>(object:Dictionary<T>,
                                  callback?:DictionaryIterator<T, void>,
                                  thisArg?:any): Dictionary<T>;
        /**
         * @see _.forOwnRight
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.forOwnRight
         **/
        forOwnRight<T extends {}>(callback:ObjectIterator<T, void>,
                                  thisArg?:any): _.LoDashObjectWrapper<T>;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.mapKeys
         */
        mapKeys<TObject extends {}>(iteratee?:TObject): LoDashObjectWrapper<Dictionary<T>>;

        /**
         * @see _.mapKeys
         */
        mapKeys(iteratee?:string): LoDashObjectWrapper<Dictionary<T>>;
    }
    ...
    interface LoDashObjectWrapper<T> {
        ...
        mapKeys<TResult, TKey>(iteratee?:ListIterator<TResult, TKey>|DictionaryIterator<TResult, TKey>,
                               thisArg?:any): LoDashObjectWrapper<Dictionary<TResult>>;

        /**
         * @see _.mapKeys
         */
        mapKeys<TResult, TObject extends {}>(iteratee?:TObject): LoDashObjectWrapper<Dictionary<TResult>>;

        /**
         * @see _.mapKeys
         */
        mapKeys<TResult>(iteratee?:string): LoDashObjectWrapper<Dictionary<TResult>>;
    }
    ...
    interface LoDashStatic {
         ...
         * @return The destination object.
         **/
        merge<P, T, S1, Value, Result>(object:T,
                                       s1:S1,
                                       callback?:(objectValue:Value, sourceValue:Value) => Value,
                                       thisArg?:any): Result;
         ...
         * @see _.merge
         **/
        merge<P, T, S1, S2, Value, Result>(object:T,
                                           s1:S1,
                                           s2:S2,
                                           callback?:(objectValue:Value, sourceValue:Value) => Value,
                                           thisArg?:any): Result;
         ...
         * @see _.merge
         **/
        merge<P, T, S1, S2, S3, Value, Result>(object:T,
                                               s1:S1,
                                               s2:S2,
                                               s3:S3,
                                               callback?:(objectValue:Value, sourceValue:Value) => Value,
         ...
         * @see _.merge
         **/
        merge<P, T, S1, S2, S3, S4, Value, Result>(object:T,
                                                   s1:S1,
                                                   s2:S2,
                                                   s3:S3,
                                                   s4:S4,
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.omit
         **/
        omit<Omitted>(...keys:string[]): LoDashObjectWrapper<Omitted>;
         ...
         * @see _.omit
         **/
        omit<Omitted>(callback:ObjectIterator<any, boolean>,
    ...
    interface LoDashStatic {
         ...
         */
        pick<TResult extends Object, T extends Object>(object:T,
         ...
         */
        pick<TResult extends Object, T extends Object>(object:T,
                                                       ...predicate:Array<string|number|boolean|Array<string|number|boolean>>): TResult;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.pick
         */
        pick<TResult extends Object>(predicate:ObjectIterator<any, boolean>,
                                     thisArg?:any): LoDashObjectWrapper<TResult>;

        /**
         * @see _.pick
         */
        pick<TResult extends Object>(...predicate:Array<string|number|boolean|Array<string|number|boolean>>): LoDashObjectWrapper<TResult>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.set
         */
        set(path:StringRepresentable|StringRepresentable[],
    ...
    interface LoDashStatic {
         ...
         */
        callback<TResult>(func:Function,
                          thisArg?:any): (...args:any[]) => TResult;

        /**
         * @see _.callback
         */
        callback<TResult>(func:string,
    ...
    interface LoDashObjectWrapper<T> {
         ...
         */
        mixin<TResult>(source:Dictionary<Function>,
                       options?:MixinOptions): LoDashObjectWrapper<TResult>;

        /**
         * @see _.mixin
         */
        mixin<TResult>(options?:MixinOptions): LoDashObjectWrapper<TResult>;
    }
    ...
    interface LoDashWrapper<T> {
         ...
         * @see _.times
         */
        times<TResult>(iteratee:(num:number) => TResult,
                       thisArgs?:any): LoDashArrayWrapper<TResult>;
